...
{
    public class FindComfort : JobTask
    {
        public override void Action_Start()
        {
            ...
            if (comfortSpots.Count > 0)
            {
                ...
                if (comfortSpot?.Location != null)
                {
                    ...
                    Direction = comfortSpot.Direction;
                }
            }
        }
        ...
        private void PathTo(bool desperate)
        {
            if (Location == null ||
        ...
        private void ContinuePathing(bool desperate)
        {
            if (Owner_Character?.Location == null ||
                TimeManager.Now == null)
            {
